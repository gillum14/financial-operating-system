...
// Every row below uses a fixed, hardcoded UUID rather than a generated one so
// the seed script can be re-run safely (onConflictDoNothing keys off these).
// All names, institutions, and amounts are synthetic — no real people,
// accounts, or financial institutions are represented here.
...
export const devInstitutions: NewInstitution[] = [
  {
...
// Parent categories first, then children — insertion order matters because
// child rows reference their parent's id via a self-referencing FK.
export const devParentCategories: NewCategory[] = [
  { id: CATEGORY_HOUSING_ID, ownerId: DEV_USER_ID, name: "Housing" },
  { id: CATEGORY_FOOD_ID, ownerId: DEV_USER_ID, name: "Food & Dining" },
  { id: CATEGORY_TRANSPORTATION_ID, ownerId: DEV_USER_ID, name: "Transportation" },
  { id: CATEGORY_UTILITIES_ID, ownerId: DEV_USER_ID, name: "Utilities" },
  { id: CATEGORY_INCOME_ID, ownerId: DEV_USER_ID, name: "Income" },
];

export const devChildCategories: NewCategory[] = [
  { id: CATEGORY_RENT_ID, ownerId: DEV_USER_ID, name: "Rent", parentCategoryId: CATEGORY_HOUSING_ID },
  {
    id: CATEGORY_GROCERIES_ID,
    ownerId: DEV_USER_ID,
    name: "Groceries",
    parentCategoryId: CATEGORY_FOOD_ID,
  },
  {
    id: CATEGORY_RESTAURANTS_ID,
    ownerId: DEV_USER_ID,
    name: "Restaurants",
    parentCategoryId: CATEGORY_FOOD_ID,
  },
...
export const devAccounts: NewAccount[] = [
  {
...
export const devTransactions: NewTransaction[] = [
  {
...
export const devDataProviderConnections: NewDataProviderConnection[] = [
  {
