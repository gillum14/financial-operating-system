...
// .../budgets/error.tsx, .../goals/error.tsx, .../reports/error.tsx, and
// .../missions/error.tsx.
export default function InvestmentsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    console.error("Investments page failed to load:", error);
  }, [error]);

  return (
    <Card className="text-center">
      <p className="text-lg font-semibold text-[var(--foreground)]">Unable to load your investments</p>
